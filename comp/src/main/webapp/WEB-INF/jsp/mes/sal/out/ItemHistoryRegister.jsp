...
// 출고번호검색 모달
	...
	$('#searchHisBtn').click(function(){
		...
		hisNumSearch.onclick = function() {
			itmHisNum1 = null;
			aDate = $(".modal-body").find('input[name="hisADate"]').val();
			bDate = $(".modal-body").find('input[name="hisBDate"]').val();
...
// 		}
	...
	grid5.on('scrollEnd', () => {
	  ...
	  let today = new Date();
		...
		var datepicker = new tui.DatePicker('#ordaadate', {
	        date: today,
	        language: 'ko',
	        input: {
	            element: '#ordBDate',
		...
		var datepicker = new tui.DatePicker('#ordbbdate', {
	        date: today,
	        language: 'ko',
	        input: {
	            element: '#ordADate',
		...
		var datepicker = new tui.DatePicker('#hisbbdate', {
	        date: today,
	        language: 'ko',
	        input: {
	            element: '#hisBDate',
		...
		var datepicker = new tui.DatePicker('#hisaadate', {
	        date: today,
	        language: 'ko',
	        input: {
	            element: '#hisADate',
							...
							<div class="col" align="center">
								...
								<table>
									<tr>
										<td>
											<div class="tui-datepicker-input tui-datetime-input tui-has-focus">
												<input type="text" id="ordBDate" name="ordBDate" class=" form-control" aria-label="Date-Time"
													style="text-align: center;" /> <span class="tui-ico-date"></span>
											</div>
											<div id="ordbbdate" style="margin-top: -1px;"></div>
										</td>
										<td align="center"><h3>  ~ </h3></td>
										<td>
											<div class="tui-datepicker-input tui-datetime-input tui-has-focus">
												<input type="text" id="ordADate" name="ordADate"
														class=" form-control" aria-label="Date-Time"
														style="text-align: center;" /> <span class="tui-ico-date"></span>
											</div>
											<div id="ordaadate" style="margin-top: -1px;"></div>
										</td>
									</tr>
								</table>
							</div>
