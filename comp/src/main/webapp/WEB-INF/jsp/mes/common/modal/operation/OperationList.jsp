...
<form:form commandName="searchVO" name="listForm" id="listForm" method="post">
	<input type="hidden" name="operCode" />
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">OperId</th>
								<th align="center">OperPhone</th>
							</tr>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			<tr>
													<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.operCode}"/>')"><c:out value="${result.operCode}"/></a>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.operName}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.operId}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.operPhone}"/>&nbsp;</td>
				    			</tr>
			</c:forEach>
		</table>
	</div>
