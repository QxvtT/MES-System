					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						<tr>
							<td align="center" class="listtd"><a
								href="javascript:fn_egov_select('<c:out value="${result.operCode}"/>')"><c:out
										value="${result.operCode}" /></a>&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.operName}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.operId}" />&nbsp;</td>
							<td align="center" class="listtd"><c:out
									value="${result.operPhone}" />&nbsp;</td>
						</tr>
					</c:forEach>
				</table>
			</div>
