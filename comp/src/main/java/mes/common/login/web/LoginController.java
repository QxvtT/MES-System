...
public class LoginController {
	...
	public String loginUsrView(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		*/
		...
		return "mes/common/login/loginView";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/egovIdPasswordSearch.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/egovGpkiIssu.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/getEncodingData.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/EgovGpkiRegist.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/actionGpkiRegist.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/noticeExpirePwd.do")
