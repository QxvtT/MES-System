...
public class OperationController {
	...
	@ResponseBody
	public List<?> ajaxSelectOperationList(OperationVO searchVO, ModelMap model) throws Exception {
	...
	public String operationList(OperationVO searchVO, ModelMap model) throws Exception {
	...
	public String selectItemList(ItemVO searchVO, ModelMap model) throws Exception {
	...
	@ResponseBody
	public List<?> ajaxselectProcessList(ProcessVO searchVO, ModelMap model) throws Exception {
	...
	public String selectProcessList(ProcessVO searchVO, ModelMap model) throws Exception {
	...
	@ResponseBody
	public List<?> ajaxselectMaterialList(MaterialVO searchVO, ModelMap model) throws Exception {
	...
	public String selectMaterialList(MaterialVO searchVO, ModelMap model) throws Exception {
	...
	@ResponseBody
	public List<?> ajaxSelectMachineList(MachineVO searchVO, ModelMap model) throws Exception {
	...
	public String selectSelectMachineList(MachineVO searchVO, ModelMap model) throws Exception {
	...
	public List<?> ajaxSelectEmployeesList(EmployeesVO searchVO, ModelMap model) throws Exception {
		...
		List<?> EmployeesList = operationService.selectEmployeesList(searchVO);
